...
export const Footer = () => {
  return (
    <>
      <footer className="bg-black py-12 sm:py-16 border-t border-brand-gray/20">
        <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-gray-400 text-sm font-medium">
              ...
              <Link to="/treino-idosos" className="hover:text-brand-yellow transition-colors text-brand-yellow font-semibold">Treino 50+</Link>
        ...
        <div className="container mx-auto px-4 sm:px-6 mt-12 sm:mt-16 pt-6 sm:pt-8 border-t border-brand-gray/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs tracking-widest uppercase">
      ...
      <a 
        ...
        className="fixed bottom-5 right-4 sm:bottom-6 sm:right-6 z-[100] bg-[#25D366] text-white p-3.5 sm:p-4 rounded-full shadow-lg hover:scale-110 hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] transition-all duration-300 flex items-center justify-center group touch-manipulation"
      >
