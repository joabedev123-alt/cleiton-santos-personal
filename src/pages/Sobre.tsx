    ...
    <div className="py-20 md:py-28 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 items-center">
          ...
          <div className="bg-black w-full max-w-[320px] lg:max-w-[360px] mx-auto aspect-[9/16] flex items-center justify-center border-4 border-brand-yellow/20 relative overflow-hidden group shadow-2xl rounded-sm">
            ...
            <video src="/videos/video01.mp4" autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-contain bg-black object-center z-0" />
          </div>
        </div>
      </div>
    </div>
